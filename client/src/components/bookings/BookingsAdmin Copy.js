        ...
        <div class="px-4 py-4 -mx-4 overflow-x-auto sm:-mx-8 sm:px-8">
            <div class="inline-block min-w-full overflow-hidden rounded-lg shadow">
                <table class="min-w-full leading-normal">
                    <thead>
                        <tr>
                            <th scope="col" class="px-5 py-3 text-l font-bold text-left text-gray-800 uppercase bg-white border-b border-gray-200">
                            Hall Name
                            </th>
                            <th scope="col" class="px-5 py-3 text-l font-bold text-left text-gray-800 uppercase bg-white border-b border-gray-200">
                            Event Name
                    ...
                    <tbody>
                        <tr>
                        <td class="px-5 py-5 font-bold text-m  bg-white border-b border-gray-200">
                                <p class="text-gray-900 whitespace-no-wrap">
                                {booking.bookedHallName}  
                                </p>
                            </td>
                            <td class="px-5 py-5 text-m bg-white border-b border-gray-200">
                                <p class="text-gray-900 whitespace-no-wrap">
                                {booking.eventName}
                                </p>
                            </td>
                          ...
                          {booking.isApproved === "Rejected By Admin" && (
                            ...
                            <td class="px-5 py-5 text-m bg-white border-b border-gray-200">
                                <button className="text-m font-semibold ml-5 leading-none text-gray-600 py-3 px-5 bg-gray-200 rounded hover:bg-gray-300 focus:outline-none">View</button>
                                <button className="text-m font-semibold ml-5 leading-none text-gray-600 py-3 px-5 bg-gray-200 rounded hover:bg-yellow-300 focus:outline-none">Edit</button>
                                <button className="text-m font-semibold ml-5 leading-none text-gray-600 py-3 px-5 bg-gray-200 rounded hover:bg-green-300 focus:outline-none">Approve</button>
                                <button className="text-m font-semibold ml-5 leading-none text-gray-600 py-3 px-5 bg-gray-200 rounded hover:bg-red-300 focus:outline-none">Reject</button>
