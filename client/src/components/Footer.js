...
const Footer = () => {
  ...
  <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
    ...
    <span class="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
      ...
      <a href="https://github.com/siddharth9300" rel="noopener noreferrer" target="_blank" class="ml-3 text-gray-500">
      <svg fill="currentColor" class="w-5 h-5" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"  viewBox="0 0 640 640">
